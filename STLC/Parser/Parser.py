...
from STLC.Parser.AST import Variable,BoolLiteral, IntLiteral,UnitLiteral, Expression, Application,Function
...
application : Parser[Application] = bind(lparen
                , lambda _ : 
                bind (expression, 
                      lambda e1 : 
                      bind ( expression,
...
def make_expression_parser()-> Parser[Expression]:
    parser_list : list[Parser[Expression]] = [
        variable,boolLiteral,intLiteral,unitLiteral
        , application
        , function
        ]
