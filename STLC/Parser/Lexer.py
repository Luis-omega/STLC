...
def string_with(
    stream: str, to_lex: str, get_value: Callable[[str], T]
...
boolTrue: Callable[[str], Optional[tuple[str, Token]]] = lambda stream: string(
    stream, "True", TokenBool(True)
)
boolFalse: Callable[[str], Optional[tuple[str, Token]]] = lambda stream: string(
    stream, "False", TokenBool(False)
)
...
] = lambda stream: string(stream, "\\", LambdaStart())
arrow: Callable[[str], Optional[tuple[str, Token]]] = lambda stream: string(
    stream, "->", Arrow()
)
if_: Callable[[str], Optional[tuple[str, Token]]] = lambda stream: string(
    stream, "if", If()
)
else_: Callable[[str], Optional[tuple[str, Token]]] = lambda stream: string(
    stream, "else", Else()
)
then: Callable[[str], Optional[tuple[str, Token]]] = lambda stream: string(
    stream, "then", Then()
)
colon: Callable[[str], Optional[tuple[str, Token]]] = lambda stream: string(
    stream, ":", Colon()
)
boolType: Callable[[str], Optional[tuple[str, Token]]] = lambda stream: string(
    stream, "Bool", TokenTypeBool()
)
intType: Callable[[str], Optional[tuple[str, Token]]] = lambda stream: string(
    stream, "Int", TokenTypeInt()
)
unitType: Callable[[str], Optional[tuple[str, Token]]] = lambda stream: string(
    stream, "Unit", TokenTypeUnit()
)
equal: Callable[[str], Optional[tuple[str, Token]]] = lambda stream: string(
    stream, "=", Equal()
)
...
def one_of(
    stream: str, functions: list[Callable[[str], Optional[tuple[str, Token]]]]
